	...
	<div class="col-md-12">
			<div class="panel panel-success">
			  ...
			  <div class="panel-body"></div>
			        ...
			        <div class="text-center">
			        	<form method="POST" action="/reader/confirm_register">
							账号：<input type="text" name="name" size="20" required><br><br>
							密码：<input type="password" name="password" size="20" required><br><br>
							
							<input type="submit" value="注册" name="B1">&nbsp;&nbsp;<input type="reset" value="重置" name="B2">
						</form>
						<br>
						<div class="text-danger">注册失败，账号已存在！</div>
			        </div>
			        <br>
